    ...
    >
      <div className="bg-white/40 border border-white/40 rounded-3xl p-8 shadow-sm ring-1 ring-white/20">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full py-5 px-6 bg-primary hover:bg-emerald-700 text-white font-black uppercase tracking-widest text-sm rounded-2xl transition-all duration-300 shadow-xl shadow-primary/20 active:scale-[0.98] mt-4 hover:shadow-2xl hover:-translate-y-0.5"
          >
            Continue Assessment
          </button>
        </form>
